...
export class AppComponent implements OnInit {
  ...
  timeline: TimelineElement[] = [
    ...
    { caption: '28 Feb', date: new Date(2014, 1, 16), title: 'Event title here', content: this.content },
    { caption: '20 Mar', date: new Date(2014, 1, 26), title: 'Event title here', content: this.content },
